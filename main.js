...
/* harmony export */   "appendSiblings": () => (/* binding */ appendSiblings),
/* harmony export */   "clearInnerText": () => (/* binding */ clearInnerText),
/* harmony export */   "createSimilarElems": () => (/* binding */ createSimilarElems),
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n    margin: 0px; /* no white border */\n    font-family: sans-serif;\n}\n\n#contentContainer {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    background-color: rgb(46, 31, 31);\n    min-height: 100vh; /* fill screen */\n}\n\n#etchContainer {\n    padding: 2.5vh; /* 'border' of picture */\n    background-color: darkgray;\n    display: grid;\n    grid-template-columns: repeat(16, 62px);\n    grid-template-rows: repeat(16, 62px); /* unnecessary */\n    width: 80vh;\n    height: 80vh;\n}\n\n.etchDiv {\n    background-color: white;\n}\n\n.row {\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    align-items: center;\n}\n\n#optionsContainer {\n    gap: 2.5vh;\n    background-color: rgb(156, 156, 156);\n    width: 85vh; /* same as etchContainer + padding */\n    padding-top: 2.5vh;\n    padding-bottom: 2.5vh;\n}\n\n.option:first-child {\n    margin-left: 2.5vh;\n}\n\n.option:last-child {\n    margin-right: 2.5vh;\n}\n\n#toggleContainer {\n    gap: 1vh;\n    background: rgb(212, 212, 212);\n}\n\n#sliderContainer {\n    gap: 0.5vh;\n}\n\n#slider {\n    -webkit-appearance: none;  /* Override default CSS styles */\n    appearance: none;\n}\n\n.hidden {\n    display: none;\n}\n\n.opac {\n    opacity: 0.8;\n    -webkit-transition: .1s; /* 0.2 seconds transition on hover */\n    transition: opacity .1s;\n}\n\n.opac:hover {\n    opacity: 1;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,WAAW,EAAE,oBAAoB;IACjC,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,iCAAiC;IACjC,iBAAiB,EAAE,gBAAgB;AACvC;;AAEA;IACI,cAAc,EAAE,wBAAwB;IACxC,0BAA0B;IAC1B,aAAa;IACb,uCAAuC;IACvC,oCAAoC,EAAE,gBAAgB;IACtD,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,UAAU;IACV,oCAAoC;IACpC,WAAW,EAAE,oCAAoC;IACjD,kBAAkB;IAClB,qBAAqB;AACzB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,QAAQ;IACR,8BAA8B;AAClC;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,wBAAwB,GAAG,gCAAgC;IAC3D,gBAAgB;AACpB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,uBAAuB,EAAE,oCAAoC;IAC7D,uBAAuB;AAC3B;;AAEA;IACI,UAAU;AACd","sourcesContent":["body {\n    margin: 0px; /* no white border */\n    font-family: sans-serif;\n}\n\n#contentContainer {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    background-color: rgb(46, 31, 31);\n    min-height: 100vh; /* fill screen */\n}\n\n#etchContainer {\n    padding: 2.5vh; /* 'border' of picture */\n    background-color: darkgray;\n    display: grid;\n    grid-template-columns: repeat(16, 62px);\n    grid-template-rows: repeat(16, 62px); /* unnecessary */\n    width: 80vh;\n    height: 80vh;\n}\n\n.etchDiv {\n    background-color: white;\n}\n\n.row {\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    align-items: center;\n}\n\n#optionsContainer {\n    gap: 2.5vh;\n    background-color: rgb(156, 156, 156);\n    width: 85vh; /* same as etchContainer + padding */\n    padding-top: 2.5vh;\n    padding-bottom: 2.5vh;\n}\n\n.option:first-child {\n    margin-left: 2.5vh;\n}\n\n.option:last-child {\n    margin-right: 2.5vh;\n}\n\n#toggleContainer {\n    gap: 1vh;\n    background: rgb(212, 212, 212);\n}\n\n#sliderContainer {\n    gap: 0.5vh;\n}\n\n#slider {\n    -webkit-appearance: none;  /* Override default CSS styles */\n    appearance: none;\n}\n\n.hidden {\n    display: none;\n}\n\n.opac {\n    opacity: 0.8;\n    -webkit-transition: .1s; /* 0.2 seconds transition on hover */\n    transition: opacity .1s;\n}\n\n.opac:hover {\n    opacity: 1;\n}"],"sourceRoot":""}]);
// Exports
...
const etchContainer = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.getElem)('etchContainer');
...
function createEtchDivs(totalDimension) {
    ...
    etchDivArray = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.createSimilarElems)('div', totalNumDiv, ['etchDiv']);
    ...
    // put on page
    (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.appendSiblings)(etchContainer, etchDivArray);
}
...
const colorSelect = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.getElem)('colorSelect');
// default options:
...
const showSliderBtn = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.getElem)('showSliderBtn');
const hideSliderBtn = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.getElem)('hideSliderBtn');
const sliderContainer = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.getElem)('sliderContainer');
...
const slider = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.getElem)('slider');
const sliderText = (0,_function_js__WEBPACK_IMPORTED_MODULE_0__.getElem)('sliderText');
